...
################################################################################
#   LSTM Closing Price Prediction With Full Sell Trailing Stop Loss Strategy   #
#                                                                              #
...
# loss is applied for full sell orders (all assets of a cryptocurrency are     #
# sold once a 1.5% trailing loss is hit).                                      #
################################################################################
